...
/// Use this as a means to generate states for testing
...
impl CombinedStateGenerator {
    /// random_state_init_op is just for whether or not you want the default state to be generated from the RandomState setter or not
